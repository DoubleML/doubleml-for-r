context("Unit tests for PLIV.partialZ with covariates X")
...
patrick::with_parameters_test_that("Unit tests for PLIV.partialZ:",
  .cases = test_cases, {
    ...
    set.seed(3141)
    dim_z = 150
    pliv_hat = dml_pliv_partial_z(data_pliv_partialZ_with_X$df,
    ...
    set.seed(3141)
    double_mlpliv_obj = DoubleMLPLIV.partialZ(data_pliv_partialZ_with_X$dml_data,
      ml_r = learner_pars$ml_r$clone(),
      n_folds = 5,
      score = score,
