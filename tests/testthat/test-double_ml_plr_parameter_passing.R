...
patrick::with_parameters_test_that("Unit tests for parameter passing of PLR",
  .cases = test_cases, {
    ...
    double_mlplr_obj_exact$set_ml_nuisance_params(
      treat_var = "d1", learner = "ml_g", params = export_params_exact,
      set_fold_specific = TRUE)
    double_mlplr_obj_exact$set_ml_nuisance_params(
      treat_var = "d1", learner = "ml_m", params = export_params_exact,
      set_fold_specific = TRUE)
    double_mlplr_obj_exact$set_ml_nuisance_params(
      treat_var = "d2", learner = "ml_g", params = export_params_exact,
      set_fold_specific = TRUE)
    double_mlplr_obj_exact$set_ml_nuisance_params(
      treat_var = "d2", learner = "ml_m", params = export_params_exact,
      set_fold_specific = TRUE)
