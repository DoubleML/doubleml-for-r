...
test_that("Unit tests for the method set_sample_splitting of class DoubleML", {
  ...
  smpls = list(train_ids = list(c(1, 2, 3, 4, 5)),
  ...
  smpls = list(train_ids = list(seq(10)),
  ...
  smpls = list(train_ids = list(c(1, 2, 3, 4, 5)),
               test_ids = list(c(6, 7)),
               ids = list(c(8, 9, 10)))
  msg = paste("Assertion on 'names\\(smpl\\)' failed: Must be equal to set",
  ...
  smpls = list(train_ids = list(c(1, 2, 3, 4, 5), c(6, 7, 8, 9, 10)),
  ...
  smpls = list(train_ids = list(c(1, 2, 3, 4, 5), c(6, 7, 8, 9)),
               test_ids = list(c(6, 7, 8, 9, 10), c(1, 2, 3, 4, 5, 10)))
  msg = paste("Invalid partition provided. Tuples \\(train_ids, test_ids\\)",
              "for more than one fold provided that don't form a partition.")
  expect_error(dml_plr$set_sample_splitting(smpls),
               regexp = msg)
  
  # sample splitting with cross-fitting and two folds that do not form a partition
  smpls = list(list(train_ids = list(c(1, 2, 3, 4, 5), c(6, 7, 8, 9)),
                    test_ids = list(c(6, 7, 8, 9, 10), c(1, 2, 3, 4, 5, 10))))
  msg = paste("Invalid partition provided. Tuples \\(train_ids, test_ids\\)",
              "for more than one fold provided that don't form a partition.")
  expect_error(dml_plr$set_sample_splitting(smpls),
  ...
  smpls = list(list(train_ids = list(c(1, 2, 3, 4, 5), c(6, 7, 8, 9, 10)),
                    test_ids = list(c(6, 7, 8, 9, 10), c(1, 2, 3, 4, 5))),
               list(train_ids = list(c(1, 3, 5, 7, 9),
                                     c(2, 4, 6, 7, 8, 9, 10),
                                     c(1, 2, 3, 5, 4, 6, 8, 10)),
                    test_ids = list(c(2, 4, 6, 8, 10),
                                    c(1, 3, 5),
                                    c(7, 9))))
  ...
  smpls = list(list(train_ids = list(c(1, 2, 3, 4, 5)),
                    test_ids = list(c(6, 7, 8, 9, 10))),
               list(train_ids = list(c(2, 4, 6, 8, 10)),
