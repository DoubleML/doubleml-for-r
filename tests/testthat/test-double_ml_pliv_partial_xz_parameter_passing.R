...
patrick::with_parameters_test_that("Unit tests for parameter passing of PLIV",
  ...
  double_mlpliv_obj_exact$set_ml_nuisance_params(treat_var = "d", learner = "ml_g", params = export_params_exact_g, 
                                                  set_fold_specific = TRUE)
  double_mlpliv_obj_exact$set_ml_nuisance_params(treat_var = "d", learner = "ml_m", params = export_params_exact_m, 
                                                  set_fold_specific = TRUE)
