...
patrick::with_parameters_test_that("Unit tests for PLIV.partialXZ:",
  .cases = test_cases,
  {
    ...
    set.seed(3141)
    dim_z = 150
    pliv_hat = dml_pliv_partial_xz(data_pliv_partial_xz$df,
    ...
    set.seed(3141)
    double_mlpliv_obj = DoubleMLPLIV.partialXZ(data_pliv_partial_xz$dml_data,
      ml_l = learner_pars$ml_l$clone(),
      ml_m = learner_pars$ml_m$clone(),
      ml_r = learner_pars$ml_r$clone(),
      n_folds = 5,
