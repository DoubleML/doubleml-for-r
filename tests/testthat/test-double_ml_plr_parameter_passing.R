...
patrick::with_parameters_test_that("Unit tests for parameter passing of PLR (oop vs fun)",
  .cases = test_cases, {
    ...
    double_mlplr_obj$set_ml_nuisance_params(treat_var = "d1", learner = "ml_g",
                                            params = learner_pars$params$params_g)
    double_mlplr_obj$set_ml_nuisance_params(treat_var = "d2", learner = "ml_g",
                                            params = learner_pars$params$params_g)
    double_mlplr_obj$set_ml_nuisance_params(treat_var = "d1", learner = "ml_m",
                                            params = learner_pars$params$params_m)
    double_mlplr_obj$set_ml_nuisance_params(treat_var = "d2", learner = "ml_m",
                                            params = learner_pars$params$params_m)
...
patrick::with_parameters_test_that("Unit tests for parameter passing of PLR (no cross-fitting)",
  .cases = test_cases_nocf, {
    ...
    double_mlplr_obj_nocf$set_ml_nuisance_params(treat_var = "d1", learner = "ml_g",
                                                 params = learner_pars$params$params_g)
    double_mlplr_obj_nocf$set_ml_nuisance_params(treat_var = "d2", learner = "ml_g",
                                                 params = learner_pars$params$params_g)
    double_mlplr_obj_nocf$set_ml_nuisance_params(treat_var = "d1", learner = "ml_m",
                                                 params = learner_pars$params$params_m)
    double_mlplr_obj_nocf$set_ml_nuisance_params(treat_var = "d2", learner = "ml_m",
                                                 params = learner_pars$params$params_m)
...
patrick::with_parameters_test_that("Unit tests for parameter passing of PLR (fold-wise vs global)",
  .cases = test_cases, {
    ...
    dml_plr_fold_wise$set_ml_nuisance_params(treat_var = "d1", learner = "ml_g",
                                            params = params_g_fold_wise,
                                            set_fold_specific = TRUE)
    dml_plr_fold_wise$set_ml_nuisance_params(treat_var = "d2", learner = "ml_g",
                                            params = params_g_fold_wise,
                                            set_fold_specific = TRUE)
    dml_plr_fold_wise$set_ml_nuisance_params(treat_var = "d1", learner = "ml_m",
                                            params = params_m_fold_wise,
                                            set_fold_specific = TRUE)
    dml_plr_fold_wise$set_ml_nuisance_params(treat_var = "d2", learner = "ml_m",
                                            params = params_m_fold_wise,
                                            set_fold_specific = TRUE)
